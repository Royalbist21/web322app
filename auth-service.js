...
function initialize() {
    return new Promise((resolve, reject) => {
        ...
        let db = mongoose.createConnection("mongodb+srv://skhatiwada3:infocus123@web322.dbpm00l.mongodb.net/web322aap?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
        // Checking for errors
        db.on('error', (err)=>{
            reject(err);
        });
